...
// Extend Your Server Application so that every interaction is logged and is identifiable.
...
int main()
{
    ...
    while(1) {
       ...
       //Get timestamp of received message
       //Log timestamp and message received from client to file
       ...
       // Get timestamp
        ...
        strftime (t_buffer, 255, "%Y-%m-%d %H:%M:%S", timeinfo);
        // Write data to file
