...
{
    char user_input[] = "TOTORO 55555"; //DISC_PORT
    ...
    bind(BROADCAST, (struct sockaddr *)&in, sizeof(in));
...
void send_message()
{
    ...
    /*
    printf("\nEnter recipient name and message to send: ");
    gets(msg_buff);
    ...
    */
    ...
    char resp_buff[3000];
    /*strcpy(resp_buff, rec_name);
    strcat(resp_buff, " ");
    strcat(resp_buff, msg_buff);
    */
    send(MESSAGE, msg_buff, sizeof(msg_buff), 0);
    printf("\nMessage sent\n");
}
